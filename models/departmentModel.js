...
class departmentModel {
    ...
    static async updateDepartment({ id, name, frimId, leader, msg }){
        const [result] = await pool.query('UPDATE department SET name = ?, frimId = ?, leaderId = ?, msg = ? WHERE id = ?', [name, frimId, leader, msg, id]);
